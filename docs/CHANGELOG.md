...
Final acceptance/integration evidence:
...
Canonical acceptance record: `docs/milestones/m8-3-acceptance.md`. M8.4 Assisted Tracing is now unblocked and must consume the accepted M8.3 source-coordinate/calibration substrate rather than create a parallel transform/authority.
